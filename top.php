                            ...
                            <div class="col-md-3 col-lg-4 col-sm-4 col-xs-4">
                                <div class="header__right">
												...
												<ul class="navbar-nav mr-auto">
												  <li class="nav-item dropdown">
                                                    ...
                                                    <li> <a class="dropdown-item" href="profile.php">Profile</a></li>
                                                      ...
                                                      <div class="dropdown-divider"></div>
													  <a class="dropdown-item" href="show_wishlist.php">My Wishlist</a>
                                        </ul>
													</div>
												  </li>
                                    ...
                                    <div class="htc__shopping__cart">
                                        ...
                                        <a href="cart.php"><i class="fas fa-shopping-cart"></i> <span id="cart-item" class="badge badge-info" style="color:#06E1D9;"></span></a>
                                     <a href="show_wishlist.php"><i class="far fa-heart"></i><span id="wish-item" class="badge badge-light" style="color:#06E1D9;"></span></a>
